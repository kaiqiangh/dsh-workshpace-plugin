...
- **Surface redesign:** Artifacts / Memory / Git (Changes + History) use a shared scoped visual system (cards, status badges, empty/loading/error states) via `src/web/workspace-styles.ts`; remote contracts unchanged.
