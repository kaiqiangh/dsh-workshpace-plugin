...
- Expired verified records remain visible as stale repair candidates; the review surface exposes governance metadata, conflict review, Shared Project write acknowledgement, and alert-dialog focus return.
