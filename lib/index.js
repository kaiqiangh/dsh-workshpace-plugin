...
function previewMediaType(descriptor) {
...
function createWorkspaceDeliverable(descriptor, source, sizeBytes) {
	...
	const path = "path" in descriptor ? normalizeWorkspacePath(descriptor.path) : void 0;
...
//#endregion
export { PreviewPanelError, PreviewService, WorkspaceDeliverableError, WorkspaceService, apply, createPinnedContext, createWorkspaceDeliverable, deliverableResourceId, name, pinContextPath, registerPinnedContextCarrier, registerWorkspaceResourceRoute, safeDownloadName, setContextCapacity, updateContextPath };
