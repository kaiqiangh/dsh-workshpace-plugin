...
var WorkspaceArtifactCarrier = class {
	...
	async previewArtifact(id) {
		...
		return descriptorWithoutPath(artifactDescriptorPath(await this.preview.preview(entry.path), entry.path));
	}
	dispose() {
...
//#endregion
export { PreviewPanelError, PreviewService, WorkspaceArtifactCarrier, WorkspaceDeliverableError, WorkspaceService, apply, createPinnedContext, createWorkspaceDeliverable, deliverableResourceId, installWorkspaceResourceRoute, name, pinContextPath, registerPinnedContextCarrier, registerWorkspaceResourceRoute, safeDownloadName, sessionToolRecords, setContextCapacity, updateContextPath };
