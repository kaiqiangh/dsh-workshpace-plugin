...
function renderCommitDetail(result: GitCommitResult): ReactNode {
  ...
  return createElement(
    ...
    createElement("div", { "data-dsh-workspace": "history-commit-summary" },
      createElement("h3", { "data-dsh-workspace": "history-detail-hash" }, commit.sha),
      commit.decorations && createElement("div", { "data-dsh-workspace": "history-detail-deco" }, commit.decorations),
      createElement("div", { "data-dsh-workspace": "history-detail-subject" }, commit.subject),
      createElement("dl", { "data-dsh-workspace": "history-kv-list" },
        kvRow(t("history.author"), commit.author),
        kvRow(t("history.time"), `${formatAbsoluteTime(commit.time)} · ${formatRelativeTime(commit.time)}`),
